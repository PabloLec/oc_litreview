...
urlpatterns = [
    ...
    path("get_modal_ticket_response/<review_instance>", views.get_modal_ticket_response, name="get_modal_ticket_response"),
    ...
    path("reply_review/<review_instance>", views.reply_review, name="reply_review"),
